...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RIKO Beer & Grill · Duitama" },
      {
        name: "description",
        content:
          "Hamburguesas y parrilla en Duitama, Boyacá. Menú digital, pedidos por WhatsApp y Club Riko.",
      },
      { property: "og:title", content: "RIKO Beer & Grill · Duitama" },
      {
        property: "og:description",
        content: "Hamburguesas, parrilla y cerveza en Duitama. Pide por WhatsApp.",
      },
